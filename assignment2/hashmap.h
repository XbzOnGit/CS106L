...
public:
    ...
    */
    ...
    //move constructor, just the default member-wise move will work.  
    HashMap(HashMap&&) = default;
    //Cannot use default, we must free the original resources.  
    ...
    */
    ...
    //This does not have a const version, cos it will do auto-insertion.  
    //We should not make it const.  
...
private:
    ...
    */
    ...
    void copy_bucket_arr(const bucket_array_type&);
};
