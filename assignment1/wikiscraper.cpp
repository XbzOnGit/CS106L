...
unordered_set<string> findWikiLinks(const string& inp) {
    ...
    //std::ofstream ofs("~/Desktop/temp.html");
    //ofs << inp;
    //ofs.close();
    ...
    while(true) {
        ...
        //There is no double quote inside a url and I have to encode that with %22.
        auto url_end = std::find((url_start + 12),end,'"');
        ...
        string link = string(url_start + 12, url_end);
        /*
